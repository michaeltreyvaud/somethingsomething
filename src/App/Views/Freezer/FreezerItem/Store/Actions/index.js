...
export const listFreezers = () => async (dispatch) => {
  try {
    ...
    const body = {};
    //  TODO - fetch these
    const { REACT_APP_API_URL, REACT_APP_LIST_FREEZER_PATH } = process.env;
    const response = await AuthenticatedFetch(`${REACT_APP_API_URL}${REACT_APP_LIST_FREEZER_PATH}`, body);
