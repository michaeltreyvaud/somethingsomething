...
class FreezerTask extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      events: stateEvents,
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <h4 className={classes.modalTitle}>Freezer Task</h4>
          </DialogTitle>
          <DialogContent
            ...
            <Card>
              <CardBody calendar>
                <BigCalendar
                  ...
                  components={{
                    toolbar: () => <h1>TODO: Weekly Freezer Tasks</h1>,
                    day: {
                      header: () => <h1>TODO: Weekly Freezer Tasks</h1>,
                      event: () => <h1>TODO: Weekly Freezer Tasks</h1>,
                    },
                  }}
                />
              </CardBody>
...
export default withStyles(extendedFormsStyle)(FreezerTask);
