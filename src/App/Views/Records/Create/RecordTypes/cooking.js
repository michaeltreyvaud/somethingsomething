        ...
        {selectedFoodItem !== '' && (
          <div>
            ...
            <FormControl fullWidth>
              <Datetime
                value={moment(cookStartTime || '')}
                dateFormat="DD/MM/YYYY"
                inputProps={{ placeholder: 'Select Time' }}
                onChange={date => setRecordValue('cookStartTime', date.valueOf())}
              />
            </FormControl>
            <InputLabel className={classes.label}>
            ...
            <FormControl fullWidth>
              <Datetime
                value={moment(cookFinishTime || '')}
                dateFormat="DD/MM/YYYY"
                inputProps={{ placeholder: 'Select Time' }}
                onChange={date => setRecordValue('cookFinishTime', date.valueOf())}
              />
            </FormControl>
            <CustomInput
              value={temperature}
...
export default withStyles(extendedFormsStyle)(Cooking);
