  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button color="info" className={classes.marginRight} onClick={() => this.props.history.push('/dashboard/pest')}>Cancel</Button>
        <GridContainer>
          <GridItem xs={12} sm={12} md={6}>
            <Card>
              <CardHeader color="rose" icon>
                ...
                <h4 className={classes.cardIconTitle}>Create Pest Record</h4>
              </CardHeader>
              <CardBody>
                <CustomInput
                      id="disabled"
