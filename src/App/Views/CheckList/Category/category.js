...
class Category extends React.Component {
  ...
  componentDidMount() {
    const { listChecklistCategory } = this.props;
  ...
  render() {
    ...
    const simpleButtons = (item, index) => [
      ...
      switch (key) {
        case 1: {
          onClick = () => history.push(`/dashboard/checklist/category/${item.id}`);
          break;
        }
        case 2: {
            ...
            <Card>
              <CardHeader color="rose" icon>
                ...
                <Button
                  ...
                  onClick={() => history.push('/dashboard/checklist/category/create')}
                >
                  Create
                </Button>
              </CardHeader>
