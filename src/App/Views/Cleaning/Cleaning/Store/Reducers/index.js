...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    case LIST_CLEANING_ITEM_ATTEMPT: {
      return {
        ...state,
        loading: true,
        error: false,
    ...
    case LIST_CLEANING_ITEM_SUCCESS: {
    ...
    case CREATE_CLEANING_ITEM_SUCCESS: {
      const { response } = action.payload;
    ...
    case DELETE_CLEANING_ITEM_SUCCESS: {
    ...
    case UPDATE_CLEANING_ITEM_SUCCESS: {
