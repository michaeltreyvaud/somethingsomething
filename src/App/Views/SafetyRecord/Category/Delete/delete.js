...
class Delete extends Component {
  ...
  delete() {
    const { item, deletesafetyRecordCategory, loading } = this.props;
    if (loading) return false;
    const { itemId, index } = item;
    return deletesafetyRecordCategory(itemId, index);
  }
...
Delete.propTypes = {
  ...
  deletesafetyRecordCategory: PropTypes.func.isRequired,
