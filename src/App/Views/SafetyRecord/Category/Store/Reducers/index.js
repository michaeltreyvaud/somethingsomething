...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    case LIST_SAFETY_RECORD_CATEGORY_ATTEMPT: {
      return {
        ...state,
        loading: true,
        error: false,
    ...
    case LIST_SAFETY_RECORD_CATEGORY_SUCCESS: {
    ...
    case LIST_SAFETY_RECORD_CATEGORY_FAIL: {
      return {
        ...state,
        loading: false,
        error: true,
    ...
    case DELETE_SAFETY_RECORD_CATEGORY_SUCCESS: {
