...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    case LIST_TRAINING_LOG_ATTEMPT: {
      return {
        ...state,
        loading: true,
        error: false,
    ...
    case LIST_TRAINING_LOG_SUCCESS: {
    ...
    case CREATE_TRAINING_LOG_SUCCESS: {
      const { response } = action.payload;
    ...
    case UPDATE_TRAINING_LOG_SUCCESS: {
