...
class Update extends Component {
  ...
  update() {
    const { loading, updating, updateTrainingLog } = this.props;
    if (loading || updating) return false;
    return updateTrainingLog(this.state);
  }

  back() {
    const { history } = this.props;
    history.push('/dashboard/user/training');
  }
  ...
  render() {
    ...
    const {
      fromDate, toDate, trainingType, details,
    } = this.state;
    return (
      <div>
        <GridContainer>
                ...
                {!loading && (
                  <div>
                    ...
                    <CustomInput
                      ...
                      inputProps={{ placeholder: 'Type of Training' }}
...
Update.propTypes = {
  ...
  updateTrainingLog: PropTypes.func.isRequired,
};
