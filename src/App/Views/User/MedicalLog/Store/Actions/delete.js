...
export const deleteMedicalLog = (createdAt, index) => async (dispatch) => {
  try {
    ...
    //  TODO - fetch these
    const { REACT_APP_API_URL, REACT_APP_DELETE_MEDICAL_LOG_PATH } = process.env;
    await AuthenticatedFetch(`${REACT_APP_API_URL}${REACT_APP_DELETE_MEDICAL_LOG_PATH}`, body);
