...
export const updateMedicalLog = medicalLog => async (dispatch) => {
  try {
    ...
    //  TODO - fetch these
    const { REACT_APP_API_URL, REACT_APP_UPDATE_MEDICAL_LOG_PATH } = process.env;
    const updatedItem = await AuthenticatedFetch(`${REACT_APP_API_URL}${REACT_APP_UPDATE_MEDICAL_LOG_PATH}`, body);
